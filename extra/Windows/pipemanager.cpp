/*
 * Title:  spider pipemanager.cpp (Windows)
...
namespace spider
{
    ...
    void Pipemanager::show_pipes_map()
    {
        ...
        for(auto iterator = pipes_map.begin(); iterator != pipes_map.end(); ++iterator)
        {
            ...
            std::printf("|%10u|%c   |%1s      |%-46s|%-10s      |           %5s|%-46s|%-10s                  |                %5s|      %5d|%2s                |%1d                 |%-46s|%-10s               |             %5s|\n",
    ...
    std::string Pipemanager::show_pipes_map_string()
    {
        ...
        for(auto iterator = pipes_map.begin(); iterator != pipes_map.end(); ++iterator)
        {
            ...
            oss << "|" << std::right << std::setw(10) << iterator->second->get_pipe_id()
                ...
                << "|" << std::left << std::setw(10) << iterator->second->get_pipe_ip_scope_id().c_str() << "      "
                ...
                << "|" << std::left << std::setw(10) << iterator->second->get_pipe_destination_ip_scope_id().c_str() << "                  "
                ...
                << "|" << std::left << std::setw(10) << iterator->second->get_forward_proxy_ip_scope_id().c_str() << "               "
