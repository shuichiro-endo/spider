/*
 * Title:  spider spidercommand.hpp (Linux)
...
namespace spider
{
    ...
    private:
        ...
        int forward_proxy_authentication_no(std::shared_ptr<Pipe> pipe);
        int forward_proxy_authentication_basic(std::shared_ptr<Pipe> pipe);
        int forward_proxy_authentication_digest(std::shared_ptr<Pipe> pipe);
        int forward_proxy_authentication_ntlmv2(std::shared_ptr<Pipe> pipe);
        int forward_proxy_authentication_spnego_kerberos(std::shared_ptr<Pipe> pipe);
