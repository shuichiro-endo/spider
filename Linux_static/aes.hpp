/*
 * Title:  spider aes.hpp (Linux static)
...
namespace spider
{
    ...
    public:
        ...
        void set_aes_key_hex_string(std::string aes_key_hex_string);
        std::string get_aes_key_hex_string();

        void set_aes_iv_hex_string(std::string aes_iv_hex_string);
        std::string get_aes_iv_hex_string();
