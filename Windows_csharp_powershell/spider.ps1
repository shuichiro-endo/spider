...
//            routingMessage.PringBytes();
    ...
    public class Spider
    {
        ...
        private static void PrintTitle()
        {
            ...
            Console.WriteLine("         -+: ++-  -*-        _// _//_//     _// _// _//  _////   _///     ");
            Console.WriteLine("        :*-  :*-   .:.              _//                                   ");
            Console.WriteLine("        =-    -:       Windows csharp Ver: 1.21   Author: Shuichiro Endo  ");
            Console.WriteLine("");
        }
...
#$args = @("-4", "192.168.0.25", "-e", "x", "-k", "deadbeef")
#$args = @("-4", "192.168.0.25", "-e", "a", "-k", "47a2baa1e39fa16752a2ea8e8e3e24256b3c360f382b9782e2e57d4affb19f8c", "-v", "c87114c8b36088074c7ec1398f5c168a")
